...
void mostrarCreditos(){
    ...
    cout<<" -------------------------------------------"<< endl;
    cout<< "Facundo Ricardo Sosa - Legajo Nro. 28812"<< endl;
    cout<< "Jorge Cristian Garay -  Legajo Nro. 33193"<< endl;
    cout<< "Luciano Damian Cejas - Legajo Nro.32457"<< endl;
    cout<< "Pablo Nicolas Bozicek - Legajo Nro. 32602"<< endl;
    cout<< endl;
    cout<<" -------------------------------------------"<< endl<< endl;
...
void jugarPartida (string jugadorUno, string jugadorDos, int &maximoPuntaje, string &mejorJugador){
    ...
    case 1:{
        ...
        else if(puntosP1 > puntosP2 && puntosP1>=maximoPuntaje){
            maximoPuntaje= puntosP1;
            mejorJugador=jugadorUno;
        }
        else if (puntosP2>puntosP1 && puntosP2>=maximoPuntaje){
            maximoPuntaje=puntosP2;
            mejorJugador=jugadorDos;
        }
        else{
