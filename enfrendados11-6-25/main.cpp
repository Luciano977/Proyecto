...
int main()
{
    ...
    do{
        ...
        rlutil::locate(5,5);
        cout << "BIENVENIDOS AL JUEGO ENFRENDADOS"<< endl;
        cout << "--------------------------------"<< endl;
        cout << endl<< endl;
        ...
        case 1:
            ...
            case 20:
                ...
                {tiradaDados12(tiradaDoce, cantidad);
                int puntosObtenidosDoce = calcularPuntos(tiradaDoce, cantidad);
                                                                                            /// Tira el dado de 12 y suma los puntos
                for (int i = 0; i < cantidad; i++) {
                cout << "El dado " << i + 1 << " arrojo el número: " << tiradaDoce[i] << endl;
                }
                cout << "Los puntos obtenidos son: " << puntosObtenidosDoce << endl;}
                system("pause");
                break;
            case 30:
...
void mostrarCreditos(){
    ...
    cout<< "Agradecemos tu colaboracion"<< endl<< endl;
                 ...
                 /*{
                int dado1 = tirarDadosDoceCaras();
                int dado2 = tirarDadosDoceCaras();
